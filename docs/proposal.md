...
Browser mode works like a person at a computer: it types into the site's search box, scrolls the results and clicks
through them. For directory sites an AI agent (Gemini) decides each step — search, filter, scroll, next page, collect —
