...
DEFS: list[SettingDef] = [
    ...
    SettingDef("browser_retries", "Fresh-browser retries after a crash / timeout", "browser", "int", default="2",
               help="Browser errors (not CAPTCHAs): close it, open a new one and try again this many times, then use the API."),
